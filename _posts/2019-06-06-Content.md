...
#### Lập chỉ mục là gì?
Lập chỉ mục là quá trình các công cụ tìm kiếm truy cập vào website của bạn và tìm tất cả những đường dẫn có thể truy cập được sau đó lưu vào cơ sở dữ liệu của chúng, khi người dùng tìm kiếm những nội dung này sẽ xuấ hiện trên kết quá của họ.
